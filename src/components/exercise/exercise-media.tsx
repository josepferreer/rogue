...
export function ExerciseMedia({
  ...
  return (
    ...
    >
      ...
      <span className="absolute bottom-3 left-3 rounded-full bg-black/60 px-2.5 py-1 font-mono text-2xs font-medium tracking-[0.15em] text-white backdrop-blur-sm">
        {frame === 0 ? "INICIO" : "FIN"}
      </span>
    </div>
  );
